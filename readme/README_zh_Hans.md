...
### 版本历史
- **v0.0.7** (2026-08-09): 新增视频模型 Seedance 2.5
- **v0.0.6** (2026-08-09): 版本号提升及双语文档更新
- **v0.0.5** (2026-07-13): 更新 provider 鉴权模型为 `glm-5-2-260617`；在所有生图工具中新增 Seedream 5.0 Pro（`doubao-seedream-5-0-pro-260628`）；修复 Seedream 5.0 Pro 不支持 `sequential_image_generation` 参数导致的请求失败 bug
- **v0.0.4** (2026-07-12): v0.0.4 分支初始发布
- **v0.0.3** (2026-06-21): 新增 Seedance 2.0 Mini 模型支持，新增 Seedance 2.0 系列比特率控制参数（bitrate_mode）
