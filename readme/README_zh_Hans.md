...
### 版本历史
- **v0.0.4** (2026-07-12): 更新 provider 鉴权模型为 `glm-5-2-260617`；在所有生图工具中新增 Seedream 5.0 Pro（`doubao-seedream-5-0-pro-260628`）；修复 Seedream 5.0 Pro 不支持 `sequential_image_generation` 参数导致的请求失败 bug
